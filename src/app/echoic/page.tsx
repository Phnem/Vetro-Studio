            ...
            <div className="ai-cards-grid">
              <div className="ai-card gemini-pro">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/gemini.svg" alt="Gemini Pro" />
                </div>
              ...
              <div className="ai-card claude">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/claude.svg" alt="Claude" />
                </div>
              ...
              <div className="ai-card chatgpt">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/openai.svg" alt="ChatGPT" />
                </div>
              ...
              <div className="ai-card deepseek">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/deepseek.svg" alt="DeepSeek" />
                </div>
              ...
              <div className="ai-card openrouter">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/openrouter.svg" alt="OpenRouter" />
                </div>
              ...
              <div className="ai-card groq">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/groq.svg" alt="Groq" />
                </div>
              ...
              <div className="ai-card cohere">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/cohere.svg" alt="Cohere" />
                </div>
              ...
              <div className="ai-card gemini">
                <div className="ai-card-icon">
                  <img src="/Vetro/aicon/gemini.svg" alt="Gemini" />
                </div>
